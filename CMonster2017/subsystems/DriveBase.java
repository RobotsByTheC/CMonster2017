...
public class DriveBase extends Subsystem {
    ...
    public static double AverageDistance;  // shared with the DistancePID Class
    double LeftDistance;    
   ...
   double[] returnData = new double[2];
    ...
    public void DriveAutonomous (){
    	...
    	headingPID.enable();  // this should be moved to  robot.autonomousInit
    	headingPID.setSetpoint(0);
    	distancePID.enable();
    	distancePID.setSetpoint(4);
...
//   SmartDashboard.putNumber("pitch", (double)ahrs.getPitch());
 //  SmartDashboard.putNumber("roll", (double)ahrs.getRoll());
   ...
   leftMotorSpeed *= -1;
   rightMotorSpeed *= -1;
   //these 3 lines replace the arcade calculations blocks
    	...
    	//SmartDashboard.putNumber("HeadingPID", headingPID.getOutput());
    	 ...
    	 /*if (AverageDistance >= 4) {   //When in position stop by setting speed to 0.0
    		//tell the number of meters to drive before the robot stops in autonomous
    		
    		rightPIDController1.setSetpoint(0.0);
        	leftPIDController1.setSetpoint(0.0); 
        	rightPIDController2.setSetpoint(0.0);
        	leftPIDController2.setSetpoint(0.0); 
        	leftPIDController1.disable();
        	rightPIDController1.disable();
        	leftPIDController2.disable();
        	rightPIDController2.disable();
        	//disable the controllers to get out of the autonomous loop
            		
    		*/
    	}
    
    
    //call VisionStream and have it print out onto the SmartDashboard
