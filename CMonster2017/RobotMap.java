...
public class RobotMap {
    ...
    public static Solenoid moveAutonomousClampGear;
    public static Solenoid moveAutonomousUnclampGear;
    public static Solenoid moveAutonomousRaiseArm;
    public static Solenoid moveAutonomousLowerArm;
 ...
 // There are 2 driver motors on each side of the robot. 
    ...
    public static void init() {
        ...
        moveAutonomousClampGear = new Solenoid(0, 0);
        LiveWindow.addActuator("MoveAutonomous", "ClampGear", moveAutonomousClampGear);
        
        moveAutonomousUnclampGear = new Solenoid(0, 1);
        LiveWindow.addActuator("MoveAutonomous", "UnclampGear", moveAutonomousUnclampGear);
        
        moveAutonomousRaiseArm = new Solenoid(0, 2);
        LiveWindow.addActuator("MoveAutonomous", "RaiseArm", moveAutonomousRaiseArm);
        
        moveAutonomousLowerArm = new Solenoid(0, 3);
        LiveWindow.addActuator("MoveAutonomous", "LowerArm", moveAutonomousLowerArm);
