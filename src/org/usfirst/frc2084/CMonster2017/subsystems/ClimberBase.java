...
public class ClimberBase extends Subsystem {
	...
	//climber pneumatics are not used
	...
	public static Spark climberSpark = (Spark) RobotMap.climberSpark;
	...
	public void beginUnwindClimber(){
		climberTalon.set(1);
		climberSpark.set(-1);
		//keep opposite direction in case ratchet gets switched
	}
