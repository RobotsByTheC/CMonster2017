 ...
 *
 */
public class BallsGoIn extends Command {
    ...
    protected void initialize() {
    	Robot.intakeBase.ballsgoIn();
    	Robot.intakeBase.closeGate();
    	//when you push the corresponding button on the controller, this will run
    	//call the methods from intakeBase
    }
