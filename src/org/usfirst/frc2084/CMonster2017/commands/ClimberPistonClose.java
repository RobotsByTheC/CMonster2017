 ...
 *
 */
public class ClimberPistonClose extends Command {
    ...
    protected void initialize() {
    	Robot.climberBase.stopClimberPiston();
    	//when corresponding button is pressed, climber piston retracts
    	//called form climberBase
    }
