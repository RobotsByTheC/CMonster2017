...
public class AutonomousRightSide extends CommandGroup {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=PARAMETERS
        ...
        addSequential(new MoveForwardSide());
        addSequential(new TurnLeft());
        addSequential(new DropPoint());

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=COMMAND_DECLARATIONS
        
        //tells that when you choose the right side auto from the SmartDashboard,
        //it will run this sequence of commands - move forward, turn, move forward again
