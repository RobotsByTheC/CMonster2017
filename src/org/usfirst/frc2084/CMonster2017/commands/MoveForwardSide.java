 ...
 *
 */
public class MoveForwardSide extends Command {
    ...
    protected void initialize() {
    	...
    	distancePID.setOutputRange(-0.22, +0.22); //what percent of speed
    	//STAY AT 0.22!!!!!
    ...
    protected void execute() {
    	distancePID.setSetpoint(-7.0); //changed from 6.9
