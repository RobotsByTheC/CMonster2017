...
public class RobotMap {
 ...
 // There are 2 driver motors on each side of the robot. 
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
       ...
       //change modes
        driveBaseLeftTalon1.changeControlMode(TalonControlMode.PercentVbus);//changed
        driveBaseRightTalon1.changeControlMode(TalonControlMode.PercentVbus);//changed
        ...
        //set PID parameters
        driveBaseLeftTalon1.setPID(.22, 0, 0);
        driveBaseRightTalon1.setPID(.22, 0, 0);
        driveBaseLeftTalon1.setF(.101);
        driveBaseRightTalon1.setF(.101);
        
        //set nominal/peak outputs (volts
