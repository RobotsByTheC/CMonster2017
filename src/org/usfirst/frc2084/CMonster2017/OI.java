...
public class OI {
    ...
    public OI() {
        ...
        stL = new JoystickButton(rightJoystick, 5);
        stL.whenPressed(new StopLifter());
        sL = new JoystickButton(rightJoystick, 4);
        sL.whenPressed(new StartLifter());
        stC = new JoystickButton(rightJoystick, 3);
        stC.whenReleased(new StopClimber());
        sC = new JoystickButton(rightJoystick, 3);
        sC.whileHeld(new StartClimber());
        cG = new JoystickButton(rightJoystick, 2);
        cG.whenPressed(new CloseGear());
        oG = new JoystickButton(rightJoystick, 1);
